...
export default function BroadcastComposer() {
  ...
  useEffect(() => {
    apiFetch('/api/events/admin/groups').then(r => r.json()).then(setGroups)
    apiFetch('/api/events/admin/broadcasts').then(r => r.json()).then(setBroadcasts)
  }, [])
  ...
  async function handleSend() {
    ...
    const res = await apiFetch('/api/events/admin/broadcasts', {
      method: 'POST',
  ...
  async function handleDelete(id: string) {
    await fetch(`/api/events/admin/broadcasts?id=${id}`, { method: 'DELETE' })
