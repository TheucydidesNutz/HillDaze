...
export default function ImportPage() {
  ...
  async function handleCSVPreview() {
    ...
    const res = await apiFetch('/api/events/admin/import/csv', { method: 'POST', body: formData })
  ...
  async function handleICSPreview() {
    ...
    formData.append('preview', 'true')
    const res = await apiFetch('/api/events/admin/import/ics', { method: 'POST', body: formData })
    const data = await res.json()
    setIcsLoading(false)
